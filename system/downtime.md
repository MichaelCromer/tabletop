...
Game progression does not stop in Downtime, and the pressure is not totally off the players -- world events still occur, and the broader narrative may still progress (if applicable). While the players are taking Downtime actions, you as the GM will also be resolving environmental actions that advance the flow of world time.
...
If a player has a specific profession or set of skills, they can likely find work. If the player characters are in a new town, they might not have the connections needed to find very specific jobs; in this instance they will only be able to find very general unskilled work until they develop the right relationships.

Exactly what work is available will depend on the location and the specifics of your game. Basic work is always available.

| Tier | Type | Description | Base Result |
|---|---|---|---|
| 1 | Labour | General physical labour (loading, carting, digging, etc) | 1d6+M Gold/Day |
| 1 | Scribe | General writing work (letters, contracts, etc) | 1d6+W Gold/Day |
| 1 | Service | General domestic labour (house servant, table service, etc) | 1d6+C Gold/Day |
...
| Tier | Event |
|---|---|
| 1 | The players hear a Rumour |
| 1 | A notable NPC arrives at the Settlement |
| 1 | A notable crime occurs in a nearby Settlement |
| 1 | A previously cleared Dungeon is re-populated | <-- more worded like this (actual, specific event)
| 1 | A notorious NPC is rumoured to be in the area | <-- less worded like this (a "rumour")
| 1 | A treasure is rumoured to lie in a nearby Dungeon |
| 1 | TODO more | <-- it's kind of a mix of actual happenings (that the players are not necessarily aware of) and things that the players just "hear about" (which may or may not be accurate). is this the best way? should there be a separate Rumours table for the latter case?
